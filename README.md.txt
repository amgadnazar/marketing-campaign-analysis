...
A complete end-to-end data analysis project using Python, Pandas, and Power BI.

📁 Project Overview

This project analyzes the performance of multiple marketing campaigns using a real advertising dataset.
...
These KPIs were added to the dataset and exported for Power BI visualization.
...
Younger audiences (30–34) are the most cost-effective target group.

Older audiences click more but convert less.

Gender-based targeting shows that males deliver stronger conversion efficiency.
